...
/*   Updated: 2023/02/23 16:40:01 by spalta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->d_mlx->c_frm[0] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF1, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[1] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF2, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[2] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF3, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[3] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF4, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[4] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF5, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[5] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF6, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[6] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF7, &data->d_mlx->img_len, &data->d_mlx->img_hei);
	data->d_mlx->c_frm[7] = mlx_xpm_file_to_image(data->d_mlx->mlx,
			I_EF8, &data->d_mlx->img_len, &data->d_mlx->img_hei);
}
