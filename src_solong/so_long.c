...
/*   Updated: 2023/02/24 14:59:44 by spalta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (s == '1')
		mlx_put_image_to_window(data->d_mlx->mlx, data->d_mlx->win,
			data->d_mlx->w_img, x, y);
	else
	{
		mlx_put_image_to_window(data->d_mlx->mlx, data->d_mlx->win,
			data->d_mlx->o_img, x, y);
		if (s == 'P')
			mlx_put_image_to_window(data->d_mlx->mlx, data->d_mlx->win,
				data->d_mlx->p_img, x, y);
		else if (s == 'E')
			mlx_put_image_to_window(data->d_mlx->mlx, data->d_mlx->win,
				data->d_mlx->e_img, x, y);
		else if (s == 'C')
			mlx_put_image_to_window(data->d_mlx->mlx, data->d_mlx->win,
				data->d_mlx->o_img, x, y);
		else if (s == 'K')
...
int	main(int ac, char **av)
{
	...
	ft_printf("%s", "Harita Gönderilmedi!!");
}
